...
class CreateLotDispositivoDetallesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lot_dispositivo_detalles', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lot_dispositivo_detalles');
    }
}
