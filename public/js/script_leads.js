        ...
        $(document).on('click', '.show-modal', function() {
            ...
            $('#nom_bd_show').val($(this).data('nom_bd'));
    ...
    //manejo jquery para edit
        $(document).on('click', '.edit-modal', function() {
            ...
            $('#nom_bd_edit').val($(this).data('nom_bd'));
