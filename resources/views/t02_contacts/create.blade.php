		...
		<div class="row">
			<div class="col-md-12 col-md-offset1">
				...
				<div class="box">
					...
					<div class="box-header with-border">
						<h3 class="box-title">{{ trans('adminlte_lang::message.createact') }}</h3>
          ...
          <form name="form_create_contact" method="POST" action="{{ route('t02_contacts.store') }}" accept-charset="UTF-8" role="form">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-4">
                          <div class="checkbox c-checkbox">
                              <input type="checkbox" value="1" name="flag_prog" class="needsclick"> <label for="flag_prog">{{trans('adminlte_lang::message.programmed')}}</label>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-4">
                          <select class="form-control select_box" id="id_way" name="id_way" style="width: 100%" required>
                            ...
                            <option value="1">{{trans('adminlte_lang::message.incomming')}}</option>
                            <option value="2">{{trans('adminlte_lang::message.outgoing')}}</option>     
                          </select>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-4">
                          <input type="time" class="form-control" id="time_ini" name="time_ini" >
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-4">
                          <input type="time" class="form-control" id="time_fin" name="time_fin">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-4">
                          <input type="text" class="form-control" id="duration_seg" name="duration_seg" value="">
                          ...
                          <select class="form-control select_box" id="id_lead" name="id_lead" style="width: 70%" required>
                            <option value="">- Seleccione -</option>
                              @foreach ($listLeads as $lead)
                                <option value="{{$lead->id}}">{{$lead->name_lead." ".$lead->lastname_lead}}</option>
                              @endforeach  
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-10">
                          <textarea id="desc_contact" name="desc_contact" style="width: 100%" class="form-control"></textarea><p class="errorDesc text-center alert alert-danger hidden"></p>
                      </div>
                    </div><br /> 
                    <div class="form-group">
                      <label class="control-label col-lg-2" for="action">{{trans('adminlte_lang::message.actions')}}:</label>
                      <div class="col-lg-10">
                          <textarea id="action" name="action" style="width: 100%" class="form-control"></textarea>
