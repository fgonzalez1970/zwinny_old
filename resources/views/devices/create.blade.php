	...
	<div class="container-fluid spark-screen">
		<div class="row">
			<div class="col-md-12 col-md-offset1">
				...
				<div class="box">
					...
					<div class="box-header with-border">
						<h3 class="box-title">{{ trans('adminlte_lang::message.createdevice') }}</h3>
           ...
           <div class="alert alert-danger">
            ...
            @endif
          <form name="form_create_device" method="POST" action="{{ route('devices.store') }}" accept-charset="UTF-8" role="form">
					<div class="box-body">
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-2" for="id_kontaktTag">{{trans('adminlte_lang::message.tagkontakt')}}:</label>
                      <div class="col-lg-4">
                          <input type="text" class="form-control" id="id_kontaktTag" name="id_kontaktTag" value="">
                      ...
                      <div class="col-lg-4">
                          <input type="text" class="form-control" id="UUID" name="UUID" value="">
